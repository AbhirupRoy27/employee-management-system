...
function Logout({ setIsActive }) {
  ...
  return (
    <div className="absolute w-screen h-screen flex justify-center items-center bg-white/40">
      <div className="w-100 h-60 bg-[url('https://plus.unsplash.com/premium_photo-1700604012496-e7888f924bf3?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDIyM3x8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&q=60&w=900')] bg-opacity-0 bg-contain bg-center rounded-2xl p-6 flex flex-col items-center justify-center">
